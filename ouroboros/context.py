...
def build_llm_messages(
    ...
    if minimal_context_enabled():
        ...
        system_text = (
            ...
            "chat, answer normally without mentioning source tools. Reply in the "
            "language used by the owner in the current request; do not switch "
            "because tool instructions, filenames, quoted text, or attachment "
            "content use another language. If the request has no natural-language "
            "text, keep the language of the recent dialogue. Switch only when the "
            "owner explicitly asks for another language. Never expose "
