...
SETTINGS_DEFAULTS = {
    ...
    # Long-form audio remains local unless the owner explicitly selects Gemini.
    "TRANSCRIPTION_PROVIDER": "local",
    "TRANSCRIPTION_WHISPERX_MODEL": "large-v3",
    "TRANSCRIPTION_WHISPERX_DEVICE": "auto",
    "TRANSCRIPTION_WHISPERX_COMPUTE_TYPE": "float16",
    "TRANSCRIPTION_WHISPERX_BATCH_SIZE": 8,
    "TRANSCRIPTION_GEMINI_MODEL": "gemini-3.5-transcribe",
    "TRANSCRIPTION_GEMINI_MAX_BYTES": 268435456,
    "TRANSCRIPTION_GEMINI_MAX_DURATION_SEC": 7200,
    "TRANSCRIPTION_GEMINI_MAX_CHUNKS": 8,
    "TRANSCRIPTION_GEMINI_VOCAB_PHRASE_MAX_CHARS": 200,
    "TRANSCRIPTION_GEMINI_VOCAB_MAX_BYTES": 32768,
    "TRANSCRIPTION_DIARIZATION": "off",
    "TRANSCRIPTION_PYANNOTE_MODEL": "pyannote/speaker-diarization-community-1",
    "TRANSCRIPTION_PYANNOTE_DEVICE": "auto",
    "TRANSCRIPTION_PYANNOTE_MAX_DURATION_SEC": 14400,
    ...
    # Optional third model slot used after OUROBOROS_MODEL_FALLBACK. Prefer a
    # different provider/quota pool, e.g. openrouter::<model>.
    "OUROBOROS_MODEL_RESERVE": "",
    "OUROBOROS_VLM_FALLBACK_MODELS": "",
...
def apply_settings_to_env(settings: dict) -> None:
    ...
    env_keys = [
        ...
        "GROQ_API_KEY", "GROQ_BASE_URL", "GROQ_CONTEXT_LENGTH", "GROQ_MAX_TOKENS",
        "QWEN_API_KEY", "QWEN_BASE_URL", "QWEN_CONTEXT_LENGTH", "QWEN_MAX_TOKENS",
        ...
        "OUROBOROS_MODEL_CONSCIOUSNESS",
        "OUROBOROS_MODEL_FALLBACK", "OUROBOROS_MODEL_RESERVE",
        "OUROBOROS_VLM_FALLBACK_MODELS",
