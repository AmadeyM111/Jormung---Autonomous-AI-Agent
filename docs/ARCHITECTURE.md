# Ouroboros - Yourmung v2.0.0 — Architecture & Reference
...
| OUROBOROS_REVIEW_MODELS | groq::compound,qwen/qwen3.6-flash | Comma-separated reviewer slots for triad/plan/task/skill review; at least two slots are required for quorum, and duplicate model IDs are independent slots |
